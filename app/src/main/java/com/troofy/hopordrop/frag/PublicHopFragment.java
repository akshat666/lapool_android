 ...
 */
public class PublicHopFragment extends LocationBaseFragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View view =  inflater.inflate(R.layout.public_hop_list, container, false);
        ...
        this.listView = (ListView) view.findViewById(R.id.publicRequestlist);
        ...
        FloatingActionButton addPathBtn = (FloatingActionButton) view.findViewById(R.id.publicAddPathBtn);
    ...
    private void loadPickRequestsFromServer() {
        ...
        //String cacheKey = "publicPickReqListKey";

        RidesListRequest request = new RidesListRequest(getContext(), authId,token, lat,lng,pageNumber, pageSize, true);
